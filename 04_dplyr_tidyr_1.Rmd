...
`mutate` can be used to add a complete vector of the same value. That is what we'll do below. Fill in the skeleton code to create a column for a full yyyy-mm-dd style date, then make a graph of temperature throughout the year at the water quality stations. You can either color or facet by `station_code`, but differentiate them somehow.  
