...
Replace this scatterplot with one that draws boxplots. Use the cheatsheet. Try your best guess. Notice that we are now using the dataframe `d_wq` which contains *daily* averages of the water quality data.
