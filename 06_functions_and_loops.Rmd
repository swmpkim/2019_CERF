...
### mini-challenge no idea what number  
...
But say we want to save those values for later. We can set up vectors for output. We want these to be the same length as the group over which we're iterating.    
...
This concept can be extended to files in a folder on your computer: read in a file, make a bunch of graphs, and save them out as a pdf. Or read in all your daily files for the week, append them together, and save out a single weekly file.  
