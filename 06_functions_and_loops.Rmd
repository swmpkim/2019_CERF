...
A "safer" way to describe the elements you're iterating over is the `seq_along` function. This way, if for some reason you have an empty vector, you won't confuse R.  
...
For loops can be a good way to take a set of files in a folder, read each one into R and do some things to it, and export another file when you're done.  
