...
```{r}
my_plot <- function(data, param1, param2, param_facet) {
  ggplot(data) +
    geom_point(aes(x = param1, y = param2)) +
    facet_wrap(~param_facet)
}
```
